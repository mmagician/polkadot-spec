...
<\body>
  ...
  Inherents are unsigned pieces of information and only inserted into a block
  by the block author. Those entries are not gossiped on the network or
  stored in the transaction queue. It is up to the Polkadot Host to decide
  the validity of those entries and mostly serve as unverified metadata.
...
<\references>
  <\collection>
    ...
    <associate|algo-maintain-transaction-pool|<tuple|3.3|25>>
    ...
    <associate|defn-block-header|<tuple|3.6|26>>
